          ...
          <div id="optionSlider">
            ...
            >
              <div className="create-shop-option-text-container">
                ...
                <div className="create-shop-option-text-wrapper">
                  <h3>
                    What will attract more visitors to your shop? Of corse - a
                    well designed and good looking logo!
                  </h3>
                </div>
              </div>
            ...
            >
              <div className="create-shop-option-text-container">
                ...
                <div className="create-shop-option-text-wrapper">
                  <h3>
                    Another thing that will attract more customers to your shop
                    is a remembering unique name!
                  </h3>
                </div>
              </div>
            ...
            >
              <div className="create-shop-option-text-container">
                ...
                <div className="create-shop-option-text-wrapper">
                  <h3>
                    After your logo and name are ready start lising your
                    products and start making profits even from today!
                  </h3>
                </div>
              </div>
              <div className="create-shop-buttons">
            ...
            >
              <div className="create-shop-option-text-container">
                ...
                <div className="create-shop-option-text-wrapper">
                  <h3>
                    Are you ready to start this adventure and meantime develop
                    sale skills meantime? If the answer is YES - move forward!
                  </h3>
                </div>
              </div>
              <div className="create-shop-buttons">
