    ...
    <div id="product-details-wrapper">
      ...
      <div id="product-details-information-container">
        ...
        <div id="product-details-buttons-container">
          ...
          <div id="favourite-button" onClick={(e) => handleFavouriteProduct(e)}>
            {selectedFavourite ? (
        ...
        <div id="details-container">
          <p>
            ...
            regular fit • crew neckline • short sleeves • Calvin Klein monogram
            embroidery on the chest composition and care: 100% cotton machine
            wash tumble dry low
          </p>
        </div>
      </div>
